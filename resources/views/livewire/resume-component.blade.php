    ...
    <div data-aos="fade" class="aos-init aos-animate">
        <div class="container sm:px-5 md:px-10 lg:px-20">
            <div class="py-12 px-4">
                <h2 class="after-effect after:left-52 font-semibold mt-12 lg:mt-0 text-4xl dark:text-white mb-8"> Resume </h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-6">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2021-2023</span>
                        ...
                        <div
                            class="py-4 dark:bg-transparent bg-[#fff1fb] pl-5 pr-3 space-y-2 rounded-lg mb-6 dark:border-[#212425] dark:border-2">
                                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2019 -
                                                Present</span>
                        ...
                        <div
                            ...
                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2021</span>
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2017-2021</span>
                        ...
                        <div
                            ...
                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2015-2017</span>
                        ...
                        <div
                            ...
                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2008</span>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h4 class="text-2xl dark:text-white font-medium"> Awards </h4>
                        </div>
                        ...
                        <div
                            class="py-4 dark:bg-transparent bg-[#fcf9f2] pl-5 pr-3 space-y-2 rounded-lg mb-6 dark:border-[#212425] dark:border-2">
                                            <span class="text-tiny text-gray-500 dark:text-[#b7b7b7]">2014 -
                                                2015</span>
        ...
        <div class="container bg-[#f8fbfb] dark:bg-[#0D0D0D] py-12 px-4 sm:px-5 md:px-10 lg:px-20">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="col-span-1">
                    <h4 class="text-2xl dark:text-white font-medium mb-6"> Working Skills </h4>
                    <div class="mb-5">
                ...
                <!-- button group -->
                <div class="col-span-1">
                    <h4 class="text-2xl dark:text-white font-medium mb-8"> Knowledges </h4>
                    <div class="flex gap-x-3 gap-y-3 md:gap-y-6 md:gap-x-4 flex-wrap">
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Digital Design</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Marketing</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Social Media</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Print</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Time Management</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Flexibility</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Print</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Print</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Time Management</button>
                        <button class="px-3 py-2 rounded-md text-gray-600 dark:bg-gray-800 dark:text-gray-300 bg-gray-200">Flexibility</button>
