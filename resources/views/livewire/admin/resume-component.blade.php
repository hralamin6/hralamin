    ...
    <div data-aos="fade" class="aos-init aos-animate">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
                <form action="" class="mt-6 mb-0 space-y-4 dark:text-gray-200 rounded-lg p-8 border dark:border-gray-600 capitalize">
                    ...
                    <div class="relative mt-1">
                        <input type="text" wire:model.lazy="institute" class="w-full capitalize dark:text-gray-100 dark:bg-gray-800 dark:border-gray-600 rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="@lang('enter institute')"/>
                        @error('institute')<p class="text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div class="relative mt-1">
                        <input type="text" wire:model.lazy="date" class="w-full capitalize dark:text-gray-100 dark:bg-gray-800 dark:border-gray-600 rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm" placeholder="@lang('enter date')"/>
                        @error('date')<p class="text-sm text-red-600">{{ $message }}</p>@enderror
                    </div>
                    <div class="relative mt-1">
                        <select wire:model.lazy="type" name="" class="w-full capitalize dark:text-gray-100 dark:bg-gray-800 dark:border-gray-600 rounded-lg border-gray-200 p-4 pr-12 text-sm shadow-sm">
                            <option value="">@lang('select type')</option>
                            <option value="education">@lang('education')</option>
                            <option value="experience">@lang('experience')</option>
                            <option value="reward">@lang('reward')</option>
                        </select>
