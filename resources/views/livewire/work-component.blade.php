<section class="bg-white  lg:rounded-2xl dark:bg-[#111111]">
    <div class="container mb-8 px-4 sm:px-5 md:px-10 lg:px-[60px]">
        <div class="py-12">
            <h2 class="after-effect after:left-52 font-semibold mt-12 lg:mt-0 text-4xl dark:text-white">My Work </h2>
            ...
            <ul
                ...
                <li class="text-gray-600 dark:text-gray-300 mr-4 md:mx-4" data-filter=".dev">Video</li>
                <li class="text-gray-600 dark:text-gray-300 mr-4 md:mx-4" data-filter=".plugin"> Web Design</li>
                <li class="text-gray-600 dark:text-gray-300 mr-4 md:mx-4" data-filter=".branding"> Logo</li>
                <li class="text-gray-600 dark:text-gray-300 mr-4 md:mx-4" data-filter=".custom">Graphic Design</li>
            </ul>
        </div>
        <!-- End py-12 -->
