        ...
        <div class="py-12">
            ...
            <div class="grid-cols-1 lg:grid-cols-3 mt-[30px] grid gap-x-10 gap-y-7 mb-6">
                ...
                @foreach($works as $i=> $work)
                    <div class="rounded-lg mb-2 h-full dark:bg-transparent border dark:border-[#212425] dark:border-2 capitalize">
                        ...
                        <div class="grid grid-cols-2 justify-between gap-8 mt-4">
                            <a href="{{$work->preview}}" class="menu capitalize border dark:border-gray-600 text-blue-500 justify-center">@lang('see details')</a>
